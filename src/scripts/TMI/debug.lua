...
local function w(v)
  local c, d, e = ThePlayer.Transform:GetWorldPosition()
  if c and e and v and type(c) == "number" and type(e) == "number" and type(v) == "number" then
    TOOMANYITEMS.TELEPORT_DATA[v] = {}
    TOOMANYITEMS.TELEPORT_DATA[v]["x"] = c
    TOOMANYITEMS.TELEPORT_DATA[v]["z"] = e
    if TOOMANYITEMS.G_TMIP_DATA_SAVE == 1 then
      TOOMANYITEMS.SaveData(t, TOOMANYITEMS.TELEPORT_DATA)
    end
  end
end
local function x(v)
...
local function y(z)
  ...
  for B = 1, 10 do
    A[B] = {
      ...
      pos = "all",
      name = "[ " .. B .. " ]",
      tip = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TELEPORT_SLOT .. " " .. B,
      fn = {TeleportNum = B, TeleportFn = z}
    }
  end
  return A
end
local function C()
  ...
  E = E + 1
  for d, r in pairs(F) do
    D[E] = {
      beta = false,
      pos = "all",
      name = r .. (r == 1 and STRINGS.UI.PLAYERSTATUSSCREEN.AGE_DAY or STRINGS.UI.PLAYERSTATUSSCREEN.AGE_DAYS),
      tip = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SKIPDAYTIP ..
        " " .. r .. " " .. (r == 1 and STRINGS.UI.PLAYERSTATUSSCREEN.AGE_DAY or STRINGS.UI.PLAYERSTATUSSCREEN.AGE_DAYS),
      fn = {
        "confirm",
        "c_skip(" .. r .. ")",
        STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SKIPDAYSCONFIRM,
        string.format(STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SKIPDAYSCONFIRMTIP, r)
      }
    }
    E = E + 1
  end
  local G = {0.5, 1, 2, 3, 4}
  for d, H in pairs(G) do
    D[E] = {
      beta = false,
      pos = "all",
      name = H .. STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_0PRUM,
      tip = string.format(STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_0PRUMTIP, H * 100) .. "%",
      fn = {
        "confirm",
        "TheSim:SetTimeScale(" .. H .. ') print("Speed is now ", TheSim:GetTimeScale())',
        STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SPEEDRUNCONFIRM,
        string.format(STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SPEEDRUNCONFIRMTIP, H * 100) .. "% ?"
      }
    }
    E = E + 1
  end
...
return {
  ...
  {tittle = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_TEXT, list = C()},
  {
    ...
    list = {
      {
        ...
        fn = h("TENDENCY.ORNERY", "saddle_war")
      },
      {
        beta = false,
        pos = "all",
        ...
        fn = h("TENDENCY.RIDER", "saddle_race")
      },
      {
        beta = false,
        pos = "all",
        ...
        fn = h("TENDENCY.PUDGY", "saddle_race")
      },
      {
        beta = false,
        pos = "all",
        ...
        fn = h("TENDENCY.DEFAULT", "saddle_war")
      }
    }
  },
  {
  ...
  {tittle = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TELEPORT_SAVE_TEXT, list = y(x)},
  {
    ...
    list = {
      {
        ...
        fn = n({"multiplayer_portal", "multiplayer_portal_moonrock"})
      },
      {
        beta = false,
        pos = "forest",
        ...
        fn = n({"cave_entrance_open", "cave_entrance"})
      },
      {
        beta = false,
        pos = "forest",
      ...
      },
      {
        ...
        fn = n({"beequeenhive", "beequeenhivegrown"})
      },
      {
        beta = false,
        pos = "forest",
      ...
      },
      {
        ...
        fn = n({"mooseegg", "moose_nesting_ground"})
      },
      {
        beta = false,
        pos = "forest",
        ...
        fn = n({"dragonfly", "dragonfly_spawner"})
      },
      {
        beta = false,
        pos = "forest",
      ...
      },
      {
        ...
        fn = n({"sculpture_rookhead", "sculpture_knighthead", "sculpture_bishophead"})
      },
      {
        beta = false,
        pos = "forest",
        ...
        fn = n({"sculpture_rookbody", "sculpture_knightbody", "sculpture_bishopbody"})
      },
      {
        beta = false,
        pos = "forest",
        ...
        fn = n({"moon_altar_rock_glass", "moon_altar_rock_idol", "moon_altar_rock_seed"})
      },
      {
        beta = false,
        pos = "forest",
      ...
      },
      {
        ...
        fn = n({"tentacle_pillar", "tentacle_pillar_hole"})
      },
      {
        beta = false,
        pos = "cave",
      ...
      },
      {
        ...
        fn = n({"ancient_altar", "ancient_altar_broken"})
      },
      {
        beta = false,
        pos = "cave",
