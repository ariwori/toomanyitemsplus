...
STRINGS.TOO_MANY_ITEMS_UI.DEBUG_MAP_HIDE = "Temporary Hide"
STRINGS.TOO_MANY_ITEMS_UI.DEBUG_MAP_SHOWTIP = "Show all Map (need some time!)"
STRINGS.TOO_MANY_ITEMS_UI.DEBUG_MAP_HIDETIP = "Temporary Hide all Map(Re-entering the game will restore)"
