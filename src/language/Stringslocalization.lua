...
STRINGS.TOO_MANY_ITEMS_UI.BUTTON_POINTERTIP = "Active Player! Click to Change! \nInput the player nickname or index in TAB menu."
...
STRINGS.TOO_MANY_ITEMS_UI.PLAYER_NOT_ON_SLAVE_TIP = "Command not work because the player isn't in the same world with you!"
