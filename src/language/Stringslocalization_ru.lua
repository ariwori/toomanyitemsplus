...
STRINGS.TOO_MANY_ITEMS_UI.DEBUG_CHARACTER_PENALTY = "Penalty 0%"
STRINGS.TOO_MANY_ITEMS_UI.DEBUG_CHARACTER_PENALTYTIP = "Health Penalty To 0%"
...
STRINGS.TOO_MANY_ITEMS_UI.SIDEBAR_TIPFARMING = "Сельское хозяйство: полевые культуры, орудия труда и т.д."
