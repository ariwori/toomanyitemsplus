...
local ConfirmWidget = Class(Screen, function(self, config)
		...
		self.scalingroot = self:AddChild(Widget("ConfirmWidgetscalingroot"))
		self.scalingroot:SetScale(TheFrontEnd:GetHUDScale())

		self.root = self.scalingroot:AddChild(Widget("ConfirmWidgetroot"))
...
function ConfirmWidget:OnBecomeActive()
	self._base.OnBecomeActive(self)
	self.edit_text:SetFocus()
	self.edit_text:SetEditing(true)
end

function ConfirmWidget:Close()
	if self.isopen then
...
function ConfirmWidget:OverrideText(text)
	self.edit_text:SetString(text)
	self.edit_text:SetFocus()
end

function ConfirmWidget:GetText()
	return self.edit_text:GetString()
end

function ConfirmWidget:SetValidChars(chars)
	self.edit_text:SetCharacterFilter(chars)
end

function ConfirmWidget:OnControl(control, down)
	if ConfirmWidget._base.OnControl(self,control, down) then return true end
