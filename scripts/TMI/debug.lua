	...
	},
	{
		...
		list = {
...

			{
				...
				fn = {'confirm', 'TheSim:SetTimeScale(0.5) print("Speed is now ", TheSim:GetTimeScale())', STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SPEEDRUNCONFIRM, STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SPEEDRUNCONFIRMTIP }
			},
			{
				beta = false,
				pos = "all",
	...
	},
	{
		...
		list = {
			...
			},
			{
				...
				fn = 'local player = %s if player ~= nil and player.components.health then player.components.health:SetPenalty(player.components.health.penalty + 0.25) player.components.health:ForceUpdateHUD(true) end',
			},
			{
				beta = false,
				pos = "all",
